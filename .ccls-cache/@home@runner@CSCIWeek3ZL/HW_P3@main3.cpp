...
This done by using the formula Radius = ((Force*Length)/(Pi*Stress))^1/3
*/ 
...
int main() 
{
  ...
  cin >> S;
  cout << "Stress in PSI = " << S << " PSI" << endl;

  cout <<endl; //Used for Space on Console

  //Used to Calculate MM to IN
  double L_in = L/25.4;
  cout << "Length converted to In = " << L_in << " In" << endl;
